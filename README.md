...
- [`guitar-pico`](https://github.com/LowPolyPhosphorus/guitar-pico) **(4 weeks ago)**
- [`LowPolyPhosphorOS`](https://github.com/LowPolyPhosphorus/LowPolyPhosphorOS) **(4 weeks ago)**

## some stupid stuff...
<!-- STATS_LINE -->
I joined GitHub **2 years ago**. This year I've pushed ~ **785 commits**, opened **5 issues**, submitted **5 pull requests** across **35 public repos**.
